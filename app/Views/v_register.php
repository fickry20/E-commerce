          ...
          <div class="d-flex flex-column justify-content-center align-items-center gap-4">
            ...
            <div class="card p-4 rounded-lg card-auth">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" name="address" id="address" placeholder="Input your address">
              </div>
            </div>

            <div>
              <button type="submit" class="btn btn-primary px-5" style="width: 100%">Sign Up</button>
              <p class="text-primary mt-2">Sudah punya akun? <a style="font-weight: 700; text-decoration: underline" href="/login">Login now</a></p>
            </div>
          </div>
        </form>
      </div>
